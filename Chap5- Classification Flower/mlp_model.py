# -*- coding: utf-8 -*-
"""
Created on Sun Jan 26 23:06:32 2020
...
class Model(object):
    ...
    def exec_all(self, epoch_count=10, batch_size=10, learning_rate=0.001, report=10, show_cnt=3):
...
def mlp_alloc_param_pari(self, shape):
    weight = np.random.normal(0, self.rand_std, shape)
    bias = np.zeros([shape[-1]])
    return weight, bias

MlpModel.init_parameters = mlp.init_parameters
MlpModel.alloc_layer_param = mlp_alloc_layer_param
MlpModel.alloc_param_pari = mlp_alloc_param_pair