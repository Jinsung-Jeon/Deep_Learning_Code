# -*- coding: utf-8 -*-
"""
Created on Wed Feb 12 13:54:00 2020
...
class UrbanSoundDataset(Dataset):
    def __init__(self, interval, window):
        ...
        xs, ys, paths, self.target_names = load_urban_files('train.csv', 'Train', interval, window)
...
def load_urban_files(csv_filename, wav_foldername, interval, window):
    cache_path = 'C:\\Users\\Jinsung\\Documents\\Deep_Learning_Code\\Datasets\\urban-sound\\{}.{}-{}.cache'.format(wav_foldername, interval, window)
    ...
    rows, _ = load_csv('C:\\Users\\Jinsung\\Documents\\Deep_Learning_Code\\Datasets\\urban-sound\\'+csv_filename)
    ...
    for row in rows:
        ...
        wav_path = 'C:\\Users\\Jinsung\\Documents\\Deep_Learning_Code\\Datasets\\urban-sound\\{}\\{}.wav'.format(wav_foldername, row[0])
